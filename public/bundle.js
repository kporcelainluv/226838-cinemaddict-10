...
/***/ "./src/components/additionalFilmBlocks.js":
/*!************************************************!*\
  !*** ./src/components/additionalFilmBlocks.js ***!
  \************************************************/
/*! exports provided: AdditionalFilmBlock */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AdditionalFilmBlock", function() { return AdditionalFilmBlock; });
...
class AdditionalFilmBlock extends _abstractComponent__WEBPACK_IMPORTED_MODULE_0__["AbstractComponent"] {
...
/***/ "./src/components/film-containter.js":
/*!*******************************************!*\
  !*** ./src/components/film-containter.js ***!
  \*******************************************/
/*! exports provided: FilmContainer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FilmContainer", function() { return FilmContainer; });
/* harmony import */ var _abstractComponent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstractComponent */ "./src/components/abstractComponent.js");


class FilmContainer extends _abstractComponent__WEBPACK_IMPORTED_MODULE_0__["AbstractComponent"] {
  constructor() {
    super();
  }
  getTemplate() {
...
class Film extends _abstractComponent__WEBPACK_IMPORTED_MODULE_0__["AbstractComponent"] {
  constructor(data) {
    super();
...
class FilmsList extends _abstractComponent__WEBPACK_IMPORTED_MODULE_0__["AbstractComponent"] {
  constructor() {
    super();
  }
  getTemplate() {
...
class MainNav extends _abstractComponent__WEBPACK_IMPORTED_MODULE_0__["AbstractComponent"] {
  constructor() {
    super();
  }
  getTemplate() {
...
/***/ "./src/components/mainSorting.js":
/*!***************************************!*\
  !*** ./src/components/mainSorting.js ***!
  \***************************************/
/*! exports provided: MainSorting */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MainSorting", function() { return MainSorting; });
/* harmony import */ var _abstractComponent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstractComponent */ "./src/components/abstractComponent.js");


class MainSorting extends _abstractComponent__WEBPACK_IMPORTED_MODULE_0__["AbstractComponent"] {
  constructor() {
    super();
  }
  getTemplate() {
...
class Popup extends _abstractComponent__WEBPACK_IMPORTED_MODULE_0__["AbstractComponent"] {
  constructor(card) {
    super();
...
/***/ "./src/components/profileRating.js":
/*!*****************************************!*\
  !*** ./src/components/profileRating.js ***!
  \*****************************************/
/*! exports provided: ProfileRating */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProfileRating", function() { return ProfileRating; });
/* harmony import */ var _abstractComponent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstractComponent */ "./src/components/abstractComponent.js");


class ProfileRating extends _abstractComponent__WEBPACK_IMPORTED_MODULE_0__["AbstractComponent"] {
  constructor() {
    super();
  }
  getTemplate() {
...
class Search extends _abstractComponent__WEBPACK_IMPORTED_MODULE_0__["AbstractComponent"] {
  constructor() {
    super();
  }
  getTemplate() {
...
class ShowMoreButton extends _abstractComponent__WEBPACK_IMPORTED_MODULE_0__["AbstractComponent"] {
  constructor() {
    super();
  }
...
/*!*********************************!*\
  !*** ./src/components/utils.js ***!
  \*********************************/
/*! exports provided: createElement, render, unrender, Position */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _components_film__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/film */ "./src/components/film.js");
...
class MovieController {
  constructor(container, film, onDataChange, onChangeView) {
    this._film = film;
    this._filmCard = new _components_film__WEBPACK_IMPORTED_MODULE_2__["Film"](this._film);
    // TODO: remove popupTemplate
    this._popUpTemplate = new _components_popup__WEBPACK_IMPORTED_MODULE_0__["Popup"](this._film);
  ...
  setDefaultView() {
    if (this._body.contains(this._popUpTemplate.getElement())) {
      Object(_components_utils__WEBPACK_IMPORTED_MODULE_1__["unrender"])(this._popUpTemplate.getElement());
  ...
  init() {
    ...
    this._commentsButton.addEventListener(`click`, () => {
      this._onChangeView();
      Object(_components_utils__WEBPACK_IMPORTED_MODULE_1__["render"])(this._body, this._popUpTemplate.getElement(), "beforeend");
    ...
    Object(_components_utils__WEBPACK_IMPORTED_MODULE_1__["render"])(this._container, this._filmCard.getElement(), _components_utils__WEBPACK_IMPORTED_MODULE_1__["Position"].AFTERBEGIN);
...
/* harmony import */ var _components_mainSorting__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/mainSorting */ "./src/components/mainSorting.js");
/* harmony import */ var _controllers_movie_controller__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../controllers/movie-controller */ "./src/controllers/movie-controller.js");
...
/* harmony import */ var _components_film_containter__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/film-containter */ "./src/components/film-containter.js");
/* harmony import */ var _components_additionalFilmBlocks__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/additionalFilmBlocks */ "./src/components/additionalFilmBlocks.js");
/* harmony import */ var _components_showMoreBtn__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/showMoreBtn */ "./src/components/showMoreBtn.js");
/* harmony import */ var _components_mainFilter__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/mainFilter */ "./src/components/mainFilter.js");
...
class PageController {
  constructor(container, films) {
    ...
    this._subscriptions = [];
    this._films = films;
    this._filmsListBlock = new _components_films_list__WEBPACK_IMPORTED_MODULE_3__["FilmsList"]();
    this._filmsListContainer = this._filmsListBlock
      .getElement()
      .querySelector(`.films-list__container`);
    this._filmContainer = new _components_film_containter__WEBPACK_IMPORTED_MODULE_4__["FilmContainer"]();
    this._sort = new _components_mainSorting__WEBPACK_IMPORTED_MODULE_1__["MainSorting"]();
    this._mainNav = new _components_mainFilter__WEBPACK_IMPORTED_MODULE_7__["MainNav"]();
    this.onDataChange = this.onDataChange.bind(this);
    this.onChangeView = this.onChangeView.bind(this);
    this._topRatedBlock = new _components_additionalFilmBlocks__WEBPACK_IMPORTED_MODULE_5__["AdditionalFilmBlock"](`Top Rated`);
    this._showMoreBtn = new _components_showMoreBtn__WEBPACK_IMPORTED_MODULE_6__["ShowMoreButton"]();
    this._mostCommentedBlock = new _components_additionalFilmBlocks__WEBPACK_IMPORTED_MODULE_5__["AdditionalFilmBlock"](`Most Commented`);
  }
  init() {
    Object(_components_utils__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, this._sort.getElement(), `afterbegin`);
    Object(_components_utils__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, this._mainNav.getElement(), `afterbegin`);

    Object(_components_utils__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, this._filmContainer.getElement(), `beforeend`);
    Object(_components_utils__WEBPACK_IMPORTED_MODULE_0__["render"])(
  ...
  _renderFilmCard(container, film) {
    const movieController = new _controllers_movie_controller__WEBPACK_IMPORTED_MODULE_2__["MovieController"](
      container,
      film,
      this.onDataChange,
      this.onChangeView
  ...
  _unrenderFilmList() {
    Object(_components_utils__WEBPACK_IMPORTED_MODULE_0__["unrender"])(this._filmsListBlock.getElement());
...
/* harmony import */ var _components_profileRating__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/profileRating */ "./src/components/profileRating.js");
/* harmony import */ var _components_showMoreBtn__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/showMoreBtn */ "./src/components/showMoreBtn.js");
/* harmony import */ var _components_films_list__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/films-list */ "./src/components/films-list.js");
/* harmony import */ var _components_additionalFilmBlocks__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/additionalFilmBlocks */ "./src/components/additionalFilmBlocks.js");
...
/* harmony import */ var _components_film_containter__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/film-containter */ "./src/components/film-containter.js");
/* harmony import */ var _controllers_page_controller__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./controllers/page-controller */ "./src/controllers/page-controller.js");
...
const addHeaderLogo = container => {
  ...
  Object(_components_utils__WEBPACK_IMPORTED_MODULE_5__["render"])(container, headerSearchHeading, `afterbegin`);
};

const renderHeader = () => {
  const headerSearchBar = new _components_search__WEBPACK_IMPORTED_MODULE_0__["Search"]().getElement();
  const headerProfileRating = new _components_profileRating__WEBPACK_IMPORTED_MODULE_1__["ProfileRating"]().getElement();
  addHeaderLogo(headerSearchContainer);
  Object(_components_utils__WEBPACK_IMPORTED_MODULE_5__["render"])(headerSearchContainer, headerSearchBar, `beforeend`);
  Object(_components_utils__WEBPACK_IMPORTED_MODULE_5__["render"])(headerSearchContainer, headerProfileRating, `beforeend`);
};
...
(() => {
  renderHeader();
  const filmCardController = new _controllers_page_controller__WEBPACK_IMPORTED_MODULE_7__["PageController"](mainPageContainer, films);
